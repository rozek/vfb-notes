...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    // (52:8) {#if $Globals.State === 'loggingIn'}
    ...
    // (53:8) {#if $Globals.State === 'LoginFailure'}
    ...
    // (54:8) {#if $Globals.State === 'ResetRequest'}
    ...
    // (55:8) {#if $Globals.State === 'CommunicationFailure'}
    ...
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	let if_block0 = /*$Globals*/ ctx[1].State === 'Login' && create_if_block_6(ctx);
    	let if_block1 = /*$Globals*/ ctx[1].State === 'loggingIn' && create_if_block_5(ctx);
    	let if_block2 = /*$Globals*/ ctx[1].State === 'LoginFailure' && create_if_block_4(ctx);
    	let if_block3 = /*$Globals*/ ctx[1].State === 'ResetRequest' && create_if_block_3(ctx);
    	let if_block4 = /*$Globals*/ ctx[1].State === 'CommunicationFailure' && create_if_block_2(ctx);
