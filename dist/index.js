...
var app = (function () {
    ...
    /* src/CommunicationFailureMessage.svelte generated by Svelte v3.42.1 */
    ...
    class CommunicationFailureMessage extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    ***************************************************************************** */
    ...
    function create_default_slot_2(ctx) {
    	...
    	let current;
    	communicationfailuremessage = new CommunicationFailureMessage({});

    	return {
    		c() {
    			create_component(communicationfailuremessage.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(communicationfailuremessage, target, anchor);
    			current = true;
    		},
    		i(local) {
    			if (current) return;
    			transition_in(communicationfailuremessage.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(communicationfailuremessage.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(communicationfailuremessage, detaching);
    		}
    	};
    }
    ...
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	let if_block0 = /*$Globals*/ ctx[1].State === 'Login' && create_if_block_5(ctx);
    	let if_block1 = /*$Globals*/ ctx[1].State === 'LoggingIn' && create_if_block_4(ctx);
    	let if_block2 = /*$Globals*/ ctx[1].State === 'LoginFailure' && create_if_block_3(ctx);
    	let if_block3 = /*$Globals*/ ctx[1].State === 'CommunicationFailure' && create_if_block_2(ctx);
