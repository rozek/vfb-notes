...
var app = (function () {
    ...
    /* src/LoginMessage.svelte generated by Svelte v3.42.1 */
    ...
    class LoginMessage extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    ***************************************************************************** */
    ...
    // (49:8) {#if $Globals.State === 'LoggingIn'}
    ...
    function create_default_slot_2(ctx) {
    	...
    	return {
    		c() {
    			create_component(loginmessage.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(loginmessage, target, anchor);
    			current = true;
    		},
    		i(local) {
    			if (current) return;
    			transition_in(loginmessage.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(loginmessage.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(loginmessage, detaching);
    		}
    	};
    }
    ...
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	let if_block0 = /*$Globals*/ ctx[1].State === 'Login' && create_if_block_3(ctx);
    	let if_block1 = /*$Globals*/ ctx[1].State === 'LoggingIn' && create_if_block_2(ctx);
