...
var app = (function () {
    ...
    var css_248z$7 = ".Dialog.svelte-1vmqw3p.svelte-1vmqw3p.svelte-1vmqw3p{display:inline-block;flex:0 0 auto;position:relative;width:300px;height:auto;margin:0px;margin-top:-20px;border:none;border-radius:8px;padding:10px;box-shadow:0px 0px 5px 5px rgba(0,0,0,0.2);background-color:white}.Dialog.svelte-1vmqw3p a.svelte-1vmqw3p.svelte-1vmqw3p,.Dialog.svelte-1vmqw3p a.svelte-1vmqw3p.svelte-1vmqw3p:visited{color:#2980B9;text-decoration:underline}.Dialog.svelte-1vmqw3p>div.svelte-1vmqw3p.svelte-1vmqw3p{display:flex;position:relative;flex-flow:column nowrap;align-items:stretch;border:solid 2px lightgray;border-radius:4px;padding:10px}.Dialog.svelte-1vmqw3p>div.svelte-1vmqw3p>[name=\"Title\"].svelte-1vmqw3p{display:block;position:relative;padding:4px 0px 14px 0px;font-size:18px;font-weight:bold;text-align:center;color:#222222}.Dialog.svelte-1vmqw3p>div.svelte-1vmqw3p>.Block.svelte-1vmqw3p{display:block;margin:10px;text-align:justify}.Dialog.svelte-1vmqw3p>div.svelte-1vmqw3p>button.svelte-1vmqw3p{appearance:none;-webkit-appearance:none;-moz-appearance:none;-o-appearance:none;display:block;position:relative;margin:4px 0px 4px 0px;padding:6px;background-color:#2980B9;border:none;border-radius:4px;font-size:16px;font-weight:bold;color:white;cursor:pointer}.Dialog.svelte-1vmqw3p>div.svelte-1vmqw3p>button.svelte-1vmqw3p:disabled{opacity:0.3;cursor:auto}";
    styleInject(css_248z$7,{"insertAt":"top"});

    /* src/LoginFailureMessage.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "svelte-1vmqw3p");
    			attr(div1, "class", "Block svelte-1vmqw3p");
    			attr(a0, "href", "#/");
    			attr(a0, "class", "svelte-1vmqw3p");
    			attr(div2, "class", "Block svelte-1vmqw3p");
    			attr(a1, "href", "#/");
    			attr(a1, "class", "svelte-1vmqw3p");
    			attr(div3, "class", "Block svelte-1vmqw3p");
    			attr(button, "class", "svelte-1vmqw3p");
    			attr(div4, "class", "svelte-1vmqw3p");
    			attr(div5, "class", "Dialog svelte-1vmqw3p");
    		},
    		m(target, anchor) {
    ...
    class LoginFailureMessage extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    var css_248z$6 = ".Dialog.svelte-au3xmb.svelte-au3xmb.svelte-au3xmb{display:inline-block;flex:0 0 auto;position:relative;width:300px;height:auto;margin:0px;margin-top:-20px;border:none;border-radius:8px;padding:10px;box-shadow:0px 0px 5px 5px rgba(0,0,0,0.2);background-color:white}.Dialog.svelte-au3xmb>div.svelte-au3xmb.svelte-au3xmb{display:flex;position:relative;flex-flow:column nowrap;align-items:stretch;border:solid 2px lightgray;border-radius:4px;padding:10px}.Dialog.svelte-au3xmb>div.svelte-au3xmb>[name=\"Title\"].svelte-au3xmb{display:block;position:relative;padding:4px 0px 14px 0px;font-size:18px;font-weight:bold;text-align:center;color:#222222}.Dialog.svelte-au3xmb>div.svelte-au3xmb>button.svelte-au3xmb{appearance:none;-webkit-appearance:none;-moz-appearance:none;-o-appearance:none;display:block;position:relative;margin:4px 0px 4px 0px;padding:6px;background-color:#2980B9;border:none;border-radius:4px;font-size:16px;font-weight:bold;color:white;cursor:pointer}.Dialog.svelte-au3xmb>div.svelte-au3xmb>button.svelte-au3xmb:disabled{opacity:0.3;cursor:auto}";
    styleInject(css_248z$6,{"insertAt":"top"});

    /* src/LoggingInMessage.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "name", "Title");
    			attr(div0, "class", "svelte-au3xmb");
    			attr(button, "class", "svelte-au3xmb");
    			attr(div1, "class", "svelte-au3xmb");
    			attr(div2, "class", "Dialog svelte-au3xmb");
    		},
    		m(target, anchor) {
    ...
    class LoggingInMessage extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    ***************************************************************************** */
    ...
    function create_default_slot_3(ctx) {
    	...
    	let current;
    	logginginmessage = new LoggingInMessage({});

    	return {
    		c() {
    			create_component(logginginmessage.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(logginginmessage, target, anchor);
    			current = true;
    		},
    		i(local) {
    			if (current) return;
    			transition_in(logginginmessage.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(logginginmessage.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(logginginmessage, detaching);
    		}
    	};
    }
    ...
    function create_default_slot_2(ctx) {
    	...
    	let current;
    	loginfailuremessage = new LoginFailureMessage({});

    	return {
    		c() {
    			create_component(loginfailuremessage.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(loginfailuremessage, target, anchor);
    			current = true;
    		},
    		i(local) {
    			if (current) return;
    			transition_in(loginfailuremessage.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(loginfailuremessage.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(loginfailuremessage, detaching);
    		}
    	};
    }
    ...
    function create_default_slot_1(ctx) {
    	...
    	let current;
    	let if_block0 = /*$Globals*/ ctx[1].State === 'Login' && create_if_block_4(ctx);
    	let if_block1 = /*$Globals*/ ctx[1].State === 'LoggingIn' && create_if_block_3(ctx);
    	let if_block2 = /*$Globals*/ ctx[1].State === 'LoginFailure' && create_if_block_2(ctx);
